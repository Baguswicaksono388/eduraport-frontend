    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6" v-if="data">
      ...
      <div class="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-slate-700/60 dark:border-zinc-800/80 rounded-2xl p-5 space-y-4">
        <div class="border-b border-slate-100 dark:border-zinc-800 pb-2 flex justify-between items-center">
          <h4 class="font-bold text-sm text-slate-800 dark:text-slate-200 dark:text-zinc-200">Pendapatan</h4>
        ...
        <div class="flex justify-between border-t border-slate-100 dark:border-zinc-800 pt-3 font-extrabold text-xs">
          <span class="text-slate-800 dark:text-slate-200 dark:text-zinc-200">TOTAL PENDAPATAN</span>
      ...
      <div class="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-slate-700/60 dark:border-zinc-800/80 rounded-2xl p-5 space-y-4 flex flex-col justify-between">
        <div>
          <div class="border-b border-slate-100 dark:border-zinc-800 pb-2 flex justify-between items-center">
            <h4 class="font-bold text-sm text-slate-800 dark:text-slate-200 dark:text-zinc-200">Beban</h4>
        ...
        <div class="space-y-3 pt-6">
          <div class="flex justify-between border-t border-slate-100 dark:border-zinc-800 pt-3 font-extrabold text-xs">
            <span class="text-slate-800 dark:text-slate-200 dark:text-zinc-200">TOTAL BEBAN</span>
          ...
          <div class="flex justify-between border-t border-slate-100 dark:border-zinc-800 pt-3 font-extrabold text-xs items-center">
            <span class="text-slate-800 dark:text-slate-200 dark:text-zinc-200">SURPLUS / (DEFISIT)</span>
